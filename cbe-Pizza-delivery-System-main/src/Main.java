...
public class Main{
    public static void main(String[] args)
    {
        ...
        ph.accept_customer("Shreya", "Shruthi Enclave, Behind, Annughra Garden, Kallimadai, Singanallur, Tamil Nadu", 2, "8983272830");
        ph.accept_customer("Vaishnavi", "Saravana Complex, R.S. Puram, Coimbatore, Tamil Nadu", 3, "7516362455");
        ph.accept_customer("Meenakshi", "Sreevatsa Akshara Apartments, Saibaba Colony, Coimbatore, Tamil Nadu", 5, "8343269606");
